        ...
        s = ((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? n = u : u = {}, g = {}, m = {}, y = {}, v = {}, i = Object.prototype.hasOwnProperty, a = [].slice, _ = /\.js$/, h = function (e, t) {
            ...
            return e.prototype.render = function (e) {
                var t = e.call(this), n = this.options.get("translations").get("search"),
                    e = r('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" placeholder="Найти..." /></span>');
            ...
            return {
                errorLoading: function () {
                    return "Результаты не были загружены"
                    ...
                    return "Загружаем все элменты…"
                }, maximumSelected: function (e) {
                    var t = "Вы можете выбрать только " + e.maximum + " элемент";
